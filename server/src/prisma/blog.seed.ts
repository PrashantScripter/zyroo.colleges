...
const BLOGS_DATA = [
  {
    ...
    `,
    image:
      'https://plus.unsplash.com/premium_photo-1773028329721-628a5714e05a?q=80&w=1170&auto=format&fit=crop',
    category: 'Admissions',
    author: 'IIT Bombay',
  ...
  },
  {
    ...
    description:
      'VIT Vellore is set to host its annual mega technical festival TechFest 2026 with participation from 3,000+ national and international college students...',
    content: `
    ...
    `,
    image:
      'https://images.unsplash.com/photo-1584309168598-3ae5bb78c70c?q=80&w=687&auto=format&fit=crop',
    category: 'Events',
  ...
  },
  {
    ...
    description:
      'Jawaharlal Nehru University announces a comprehensive scholarship program covering full tuition, campus housing, and monthly living stipends...',
    content: `
    ...
    `,
    image:
      'https://images.unsplash.com/photo-1662042255881-da9dc04f5e28?q=80&w=1136&auto=format&fit=crop',
